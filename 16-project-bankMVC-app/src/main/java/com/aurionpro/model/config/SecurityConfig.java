...
public class SecurityConfig {
	...
	SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		http.authorizeHttpRequests(request -> request.requestMatchers("/bankapp/captcha").permitAll());
		http.authorizeHttpRequests(request -> request.requestMatchers("/bankapp/customer/{customerId}/documents").hasAnyRole("ADMIN", "CUSTOMER"));

//		http.authorizeHttpRequests(request -> request.requestMatchers(HttpMethod.GET, "/bankapp/admin/**").hasRole("ADMIN"));
		http.authorizeHttpRequests(request -> request.requestMatchers(HttpMethod.POST, "/bankapp/admin/**").permitAll());
