...
//		Add admin in the database
		...
		String body = "Dear " + adminDataDto.getUsername()
	...
	@Override
	public PageResponse<AdminDto> getAllAdmins(int pageNo, int pageSize, String sortBy, String sortDir) {
		logger.info("Fetching all admins with pagination - pageNo: {}, pageSize: {}, sortBy: {}, sortDir: {}", pageNo,
...
//		setContent logic
	...
	@Override
	public AdminDto updateAdminById(Long adminId, AdminDataDto adminDataDto) {
		logger.info("Updating admin with ID: {}", adminId);

		Admin admin = adminRepository.findById(adminId)
				.orElseThrow(() -> new NotFoundException(adminId, "Admin not found with id : "));
		admin.setAdminId(adminId);
		admin.setFirstName(adminDataDto.getFirstName());
		admin.setLastName(adminDataDto.getLastName());
		admin.setEmail(adminDataDto.getEmail());
