...
public class StudentService {
	...
	public PageResponse<Student> getAllStudents(int pageNo, int pageSize) {
		...
		studentPageResponse.setTotalElements(pageSize);
...
//	All Exceptions are throw in the service class because  service class is processing the data.
	public Student getStudentByRollNumber(int rollNumber) {
		Optional<Student> dbStudent = studentRepository.findById(rollNumber);
		if (!dbStudent.isPresent()) {
//	We are throw exceptions in the service class
